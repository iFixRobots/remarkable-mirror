...
foreach ($requiredMarker in @(
        ...
        'One complete run on a freshly reset tablet and clean Windows account',
        'is still open before the first public binary release',
...
foreach ($requiredMarker in @(
        ...
        'One complete run on a newly set up Windows account and freshly reset',
        'tablet is still open before the first public binary release',
        'images/remarkable-mirror-live-wifi.png',
        'images/remarkable-mirror-files.png',
        'images/remarkable-mirror-preparing.png',
