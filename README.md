...
pen, screenshots, and Files without sending anything through my servers.
...
- **Windows 11:** download the latest `ReMarkableMirror-Windows-x64-portable.exe` from the [releases page](https://github.com/iFixRobots/remarkable-mirror/releases) and open it.
- **macOS 14 or newer on Apple silicon:** download the latest macOS `.dmg` from the [releases page](https://github.com/iFixRobots/remarkable-mirror/releases), open it, and drag reMarkable Mirror to Applications.
...
Everything stays between your computer and tablet. There is no iFixRobots
account, analytics service, document index, screenshot upload, or cloud relay.
