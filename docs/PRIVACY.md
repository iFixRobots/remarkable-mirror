...
reMarkable Mirror talks directly to your tablet. There is no iFixRobots account,
cloud relay, analytics service, document index, or screenshot upload service.
