...
> not match the release's support statement.
...
After a firmware or root-slot switch, use **Repair Tablet Setup** only if this
release explicitly supports the new tablet software.
