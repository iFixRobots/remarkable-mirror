...
actor TabletPairingFinalizer {
    ...
    func finalizeOwnerApprovedPairing(
        ...
        if let authorizedCapability,
           authorizedCapability.meetsRuntimeContract,
    ...
    func recoverAuthorizedTabletKey(
        ...
        if proof.state == .authenticated,
           ...
           currentCapability.meetsRuntimeContract,
            ...
            if case .finishWiFi = continuation,
               ...
               capability.transportOperational {
                ...
                do {
                    ...
                    guard repairedCapability.meetsRuntimeContract,
    ...
    private func finishWiFiPairingAfterWakeToken(
        ...
        let wifi: VerifiedWiFiRoute? = nil
        let verifiedWiFiCapability = usbCapability.verified(at: now())
