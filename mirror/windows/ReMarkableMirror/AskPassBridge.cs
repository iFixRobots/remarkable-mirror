...
internal static class AskPassBridge
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            // Close the write side once the client has the bytes. The client
            // reads to end-of-pipe before answering OpenSSH, so holding the
            // pipe open deadlocks the whole authorization until its timeout.
